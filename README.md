- [DEMO LINK](https://ikseloi.github.io/js_task_clone_table_column_DOM/)

- Run `npm run test` command to test code;
...
Task: Clone the second column from the table, and append it to the table. To increase the complexity, append it in front of the last table column.
